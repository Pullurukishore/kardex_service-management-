  ...
  const statsData = [
    {
      ...
      value: stats.total,
      icon: Building2,
      gradient: 'from-[#6F8A9D] via-[#546A7A] to-[#546A7A]',
      bgGradient: 'from-[#96AEC2]/10 via-[#96AEC2]/10 to-[#6F8A9D]/10',
      borderColor: 'border-[#96AEC2]/50',
      textColor: 'text-[#546A7A]',
      valueColor: 'text-[#546A7A]',
    },
    {
      label: 'Active',
      value: stats.active,
      icon: CheckCircle2,
      gradient: 'from-[#82A094] via-[#4F6A64] to-[#4F6A64]',
      bgGradient: 'from-[#A2B9AF]/10 via-emerald-50 to-[#82A094]/10',
      borderColor: 'border-[#82A094]/50/50',
      textColor: 'text-[#4F6A64]',
      valueColor: 'text-[#4F6A64]',
    ...
    },
    {
      ...
      bgGradient: 'from-[#AEBFC3]/10 via-gray-50 to-[#AEBFC3]/10',
      borderColor: 'border-[#92A2A5]/50',
    ...
    },
    {
      ...
      icon: Package,
      gradient: 'from-[#6F8A9D] via-[#546A7A] to-[#9E3B47]',
      bgGradient: 'from-[#6F8A9D]/10 via-purple-50 to-fuchsia-50',
      borderColor: 'border-[#6F8A9D]/50/50',
      textColor: 'text-[#546A7A]',
