...
export default function BankAccountsLayout({ children }: BankAccountsLayoutProps) {
            ...
            {(!isCollapsed || isMobile) && (
              <div className="px-4 pt-4">
                <div className="flex items-center gap-2">
                  ...
                  <div className="px-3 py-1.5 rounded-lg bg-[#CE9F6B]/10 border border-[#CE9F6B]/20">
                    <span className="text-xs font-semibold text-[#976E44]">Bank Accounts</span>
                  </div>
                </div>
              </div>
            )}
        ...
        <main className="flex-1 overflow-y-auto">
          <div className={cn("min-h-full", isMobile ? "py-4 px-4" : "py-6 px-4 sm:px-6 lg:px-8")}>
            <AnimatePresence mode="wait">
              ...
              >
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl border border-[#CE9F6B]/10 shadow-xl shadow-[#CE9F6B]/5 p-5 lg:p-6">
                  {children}
                </div>
              </motion.div>
            </AnimatePresence>
