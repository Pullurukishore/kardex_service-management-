...
import NewExternalUserClient from '@/components/admin/NewExternalUserClient';

export default function NewExternalUserPage() {
  return (
    <div className="space-y-6">
      ...
      {/* New External User Form Client Component */}
      <NewExternalUserClient />
    </div>
  );
}