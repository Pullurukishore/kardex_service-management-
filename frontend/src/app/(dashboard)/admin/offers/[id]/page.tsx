          ...
          <div className="p-6 space-y-6 bg-gradient-to-b from-[#AEBFC3]/10 to-white">
            ...
            {updateData.stage && STAGE_INFO[updateData.stage] && (
              <div className={`
                ...
                ${STAGE_INFO[updateData.stage].color === 'blue' ? 'bg-gradient-to-r from-[#96AEC2]/10 to-[#96AEC2]/20/50 border-[#6F8A9D]' : ''}
                ${STAGE_INFO[updateData.stage].color === 'indigo' ? 'bg-gradient-to-r from-[#96AEC2]/10 to-[#96AEC2]/20/50 border-[#6F8A9D]' : ''}
                ${STAGE_INFO[updateData.stage].color === 'amber' ? 'bg-gradient-to-r from-[#EEC1BF]/10 to-[#EEC1BF]/20/50 border-[#CE9F6B]' : ''}
                ${STAGE_INFO[updateData.stage].color === 'purple' ? 'bg-gradient-to-r from-[#96AEC2]/10 to-[#96AEC2]/20/50 border-[#6F8A9D]' : ''}
                ${STAGE_INFO[updateData.stage].color === 'green' ? 'bg-gradient-to-r from-[#A2B9AF]/10 to-[#A2B9AF]/20/50 border-[#82A094]' : ''}
                ${STAGE_INFO[updateData.stage].color === 'teal' ? 'bg-gradient-to-r from-[#A2B9AF]/10 to-[#A2B9AF]/20/50 border-teal-500' : ''}
                ${STAGE_INFO[updateData.stage].color === 'red' ? 'bg-gradient-to-r from-[#E17F70]/10 to-red-100/50 border-[#9E3B47]' : ''}
              `}>
                <div className="flex items-start gap-4">
            ...
            <div className="bg-white rounded-xl p-4 shadow-sm border border-[#AEBFC3]/30">
              <div className="flex items-center gap-3 mb-3">
                ...
                <Label className={`text-[#546A7A] font-semibold ${updateData.stage && STAGE_INFO[updateData.stage]?.requiresAllFields ? '' : ''}`}>
                  Offer Reference Date {updateData.stage && STAGE_INFO[updateData.stage]?.requiresAllFields && <span className="text-[#E17F70]">*</span>}
                </Label>
              </div>
              <Input 
                type="date"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label className="text-sm text-[#5D6E73]">
                    Offer Value (₹) {updateData.stage && STAGE_INFO[updateData.stage]?.requiresAllFields && <span className="text-[#E17F70]">*</span>}
                  </Label>
                  <Input 
                    type="number"
                ...
                <div className="space-y-2">
                  <Label className="text-sm text-[#5D6E73]">
                    Win Probability (%) {updateData.stage && STAGE_INFO[updateData.stage]?.requiresAllFields && <span className="text-[#E17F70]">*</span>}
                  </Label>
                  <Select
            ...
            <div className="bg-white rounded-xl p-4 shadow-sm border border-[#AEBFC3]/30">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label className="text-sm text-[#5D6E73]">
                    Offer Month {updateData.stage && STAGE_INFO[updateData.stage]?.requiresAllFields && <span className="text-[#E17F70]">*</span>}
                  </Label>
                  <Input 
                    type="month"
                ...
                <div className="space-y-2">
                  <Label className="text-sm text-[#5D6E73]">
                    PO Expected Month {updateData.stage && STAGE_INFO[updateData.stage]?.requiresAllFields && <span className="text-[#E17F70]">*</span>}
                  </Label>
                  <Input 
                    type="month"
            ...
            {updateData.stage === 'LOST' && (
              <div className="bg-gradient-to-br from-[#E17F70]/10 to-[#EEC1BF]/10 rounded-xl p-5 border-2 border-[#E17F70] shadow-sm">
                ...
                />
                <div className="flex items-start gap-2 mt-3 p-3 bg-[#E17F70]/20 rounded-lg">
                  <AlertCircle className="h-4 w-4 text-[#9E3B47] mt-0.5 flex-shrink-0" />
                  <p className="text-xs text-[#75242D] font-medium leading-relaxed">
            ...
            {(updateData.stage === 'NEGOTIATION' || updateData.stage === 'FINAL_APPROVAL' || updateData.stage === 'PROPOSAL_SENT') && (
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-br from-[#96AEC2]/10 to-[#96AEC2]/10 p-5 rounded-xl border-2 border-[#96AEC2] shadow-sm">
                  ...
                  />
                  <div className="flex items-start gap-2 mt-3 p-2.5 bg-[#96AEC2]/20 rounded-lg">
