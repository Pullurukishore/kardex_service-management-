  ...
  return (
    <div className="min-h-screen bg-[#AEBFC3]/10">
      <div className="w-full p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-[#E17F70] via-[#CE9F6B] to-[#82A094] rounded-2xl shadow-xl p-6 text-white">
          ...
          <div className="relative z-10 flex justify-between items-center">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold drop-shadow-md">Offer Management</h1>
                <p className="text-white/90 mt-1">Track, manage, and convert offers to orders</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="grid grid-cols-4 gap-3">
                ...
                <div className="bg-[#82A094]/40 backdrop-blur-md rounded-lg px-4 py-2 border border-white/30 text-center shadow-lg">
                  <p className="text-white/90 text-xs font-medium">Won</p>
                ...
                <div className="bg-[#CE9F6B]/40 backdrop-blur-md rounded-lg px-4 py-2 border border-white/30 text-center shadow-lg">
                  <p className="text-white/90 text-xs font-medium">Win Rate</p>
              ...
              <Button onClick={() => router.push('/admin/offers/new')} className="bg-white text-[#9E3B47] hover:bg-[#EEC1BF] hover:text-[#75242D] shadow-lg hover:shadow-xl transition-all font-semibold">
