  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#AEBFC3]/10 via-emerald-50/30 to-[#A2B9AF]/10/20">
      <div className="w-full p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-[#82A094] via-[#82A094] to-cyan-600 rounded-2xl shadow-2xl shadow-[#82A094]/20 p-6 text-white">
          <div className="absolute top-0 right-0 w-64 h-64 bg-white/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2"></div>
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-[#96AEC2]/20 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2"></div>
          <div className="relative z-10 flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <Button onClick={() => router.push('/zone/tickets/create')} className="bg-white text-[#4F6A64] hover:bg-[#82A094]/10 shadow-lg hover:shadow-xl transition-all">
          ...
          <CardHeader className="bg-white border-b border-[#92A2A5]" style={{backgroundColor: 'white'}}>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Filter className="h-5 w-5 text-[#4F6A64]" />
              ...
              {hasActiveFilters && (
                <Button variant="ghost" size="sm" onClick={clearFilters} className="text-[#4F6A64] hover:text-[#4F6A64] hover:bg-[#82A094]/10">
        ...
        <Card className="border-0 shadow-2xl overflow-hidden bg-white">
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="bg-gradient-to-r from-[#4F6A64] via-teal-700 to-emerald-800 text-white">
                  <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider cursor-pointer hover:bg-[#4F6A64]/50 transition-colors" onClick={() => handleSort('id')}>
                  ...
                  <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider cursor-pointer hover:bg-[#4F6A64]/50 transition-colors" onClick={() => handleSort('title')}>
                    <div className="flex items-center gap-1.5">
                  ...
                  <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider cursor-pointer hover:bg-[#4F6A64]/50 transition-colors" onClick={() => handleSort('customer')}>
                    <div className="flex items-center gap-1.5">
                  ...
                  <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider cursor-pointer hover:bg-[#4F6A64]/50 transition-colors" onClick={() => handleSort('status')}>
                    <div className="flex items-center gap-1.5">
                  ...
                  <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider cursor-pointer hover:bg-[#4F6A64]/50 transition-colors" onClick={() => handleSort('priority')}>
                    <div className="flex items-center gap-1.5">
                  ...
                  <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider cursor-pointer hover:bg-[#4F6A64]/50 transition-colors" onClick={() => handleSort('assignedTo')}>
                    <div className="flex items-center gap-1.5">
                  ...
                  <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider cursor-pointer hover:bg-[#4F6A64]/50 transition-colors" onClick={() => handleSort('createdAt')}>
                    <div className="flex items-center gap-1.5">
              ...
              <tbody className="divide-y divide-gray-100">
                {loading ? (
                  <tr>
                    <td colSpan={9} className="px-6 py-16 text-center bg-gradient-to-br from-[#AEBFC3]/10 to-[#A2B9AF]/10/30">
                      <div className="flex flex-col items-center justify-center space-y-4">
                        <div className="relative">
                          <div className="h-16 w-16 rounded-2xl bg-gradient-to-br from-[#82A094] to-[#82A094] flex items-center justify-center shadow-lg">
                  ...
                  <tr>
                    <td colSpan={9} className="px-6 py-16 text-center bg-gradient-to-br from-[#AEBFC3]/10 to-[#A2B9AF]/10/30">
                      <div className="flex flex-col items-center justify-center space-y-4">
                        ...
                        <Button onClick={() => router.push('/zone/tickets/create')} className="mt-4 bg-gradient-to-r from-[#82A094] to-[#82A094]">
                          <Plus className="h-4 w-4 mr-2" />
                  ...
                  <tr 
                    ...
                    className={`
                      ...
                      hover:bg-gradient-to-r hover:from-[#A2B9AF]/10 hover:to-[#A2B9AF]/10/50 
                      transition-all duration-200 group
                    `}
                  >
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        <Link href={`/zone/tickets/${ticket.id}`} className="font-mono font-bold text-[#4F6A64] hover:text-[#4F6A64] text-sm hover:underline">
                    ...
                    <td className="px-4 py-3">
                      <div className="min-w-0">
                        <Link href={`/zone/tickets/${ticket.id}`} className="font-semibold text-[#546A7A] hover:text-[#4F6A64] text-sm truncate max-w-[200px] block hover:underline">
                          {ticket.title}
                        </Link>
          ...
          {!loading && tickets.length > 0 && (
            <div className="bg-gradient-to-r from-[#AEBFC3]/10 via-emerald-50 to-[#A2B9AF]/10/30 px-6 py-4 border-t border-[#92A2A5]">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className="hover:bg-[#82A094]/10 hover:border-emerald-300 disabled:opacity-50 rounded-xl transition-all"
                  >
