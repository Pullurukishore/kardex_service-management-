      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2 md:col-span-2">
                <Label htmlFor="zoneId">Service Zone *</Label>
                        ...
                        {formData.assetIds.map((assetId) => {
                          ...
                          return (
                            <div key={assetId} className="flex items-center gap-1 bg-[#546A7A]/10 text-[#546A7A] px-2 py-1 rounded-md text-sm">
                              ...
                              <span>{asset?.assetName || asset?.machineId || asset?.serialNo || 'Unknown'}</span>
                              <button
                                type="button"
                                onClick={() => {
        ...
        <Card className="shadow-lg border-0 bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="productType" className="text-[#9E3B47]">Product Type *</Label>
              ...
              <div className="space-y-2">
                <Label htmlFor="lead" className="text-[#9E3B47]">Lead Status *</Label>
                    ...
                    {formData.spareParts.map((part, index) => {
                      ...
                      return (
                        <div key={index} className="p-4 border border-[#CE9F6B] rounded-lg bg-[#CE9F6B]/10/50">
                          ...
                          {part.total && (
                            <div className="mt-3 p-2 bg-[#CE9F6B]/20 rounded text-right">
                              <span className="text-sm font-medium text-[#976E44]">
