    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <Button onClick={() => router.push('/expert/offers')} className="mt-4">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center gap-3 sm:gap-4 w-full sm:w-auto">
          <Button
            variant="outline"
            size="icon"
            onClick={() => router.push('/expert/offers')}
            className="shrink-0"
          >
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <Button onClick={() => router.push(`/expert/offers/${offer.id}/edit`)} className="w-full sm:w-auto">
        ...
        <div className="space-y-6">
          ...
          <Card className="shadow-xl overflow-hidden border-0">
            ...
            <CardContent className="space-y-3 pt-6 bg-gradient-to-br from-[#AEBFC3]/10 to-white">
              <Button 
                className="w-full bg-gradient-to-r from-[#82A094] to-[#82A094] hover:from-[#82A094] hover:to-[#4F6A64] text-white border-0 shadow-lg hover:shadow-xl transition-all transform hover:scale-105 font-semibold h-12 sm:h-auto py-2 sm:py-6" 
                onClick={() => {
              ...
              <Button 
                className="w-full bg-white hover:bg-[#AEBFC3]/10 text-[#546A7A] border-2 border-[#92A2A5] hover:border-[#6F8A9D] shadow-md hover:shadow-lg transition-all font-semibold h-12 sm:h-auto py-2 sm:py-5" 
              ...
              <Button 
                className="w-full bg-white hover:bg-[#AEBFC3]/10 text-[#546A7A] border-2 border-[#92A2A5] hover:border-[#6F8A9D] shadow-md hover:shadow-lg transition-all font-semibold h-12 sm:h-auto py-2 sm:py-5"
                onClick={() => router.push(`/expert/offers/${offer.id}/quote`)}
              >
              ...
              <Button 
                className="w-full bg-white hover:bg-[#AEBFC3]/10 text-[#546A7A] border-2 border-[#92A2A5] hover:border-[#6F8A9D] shadow-md hover:shadow-lg transition-all font-semibold h-12 sm:h-auto py-2 sm:py-5"
                onClick={() => router.push(`/expert/offers/${params.id}/activity`)}
              >
